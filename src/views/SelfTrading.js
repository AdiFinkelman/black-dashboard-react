...
function SelfTrading() {
  ...
  const fetchStrategies = async () => {
    try {
      // Fetch strategies if needed in future implementations
    } catch (error) {
  ...
  const handleBuy = async () => {
    try {
      const data = {
        ...
        bot_name: "manual", // Set strategy as "manual" for manual trading
      };
    ...
    <div className="content">
      ...
      <Row>
        <Col lg="6" md="12">
          <Card>
            <CardHeader>
              <CardTitle tag="h4">Buy</CardTitle>
            </CardHeader>
            <CardBody>
        ...
        <Col lg="6" md="12">
          <Card>
            <CardHeader>
              <CardTitle tag="h4">Sell</CardTitle>
            </CardHeader>
            <CardBody>
